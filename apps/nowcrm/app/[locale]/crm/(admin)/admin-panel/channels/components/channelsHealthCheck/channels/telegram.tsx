		...
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
					...
					<CardContent className="p-6">
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center gap-2">
								<span
									className={`rounded-full px-2 py-1 text-xs ${getStatusColor(telegram_credential.credential_status)}`}
								>
									{telegram_credential.credential_status}
								</span>
								{getStatusIcon(telegram_credential.credential_status)}
								<div>
									<TooltipProvider>
										<Tooltip>
			...
			<DialogContent className="min-w-max">
				...
				<div className="py-4">
					...
					{telegram_credential?.credential_status === "invalid" ||
					(telegram_credential?.credential_status === "disconnected" &&
