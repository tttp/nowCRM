...
const stepConfig = {
	...
	[STEPS.SELECT_ORGANIZATION]: {
		title: "Select Organization",
		description: "Choose or create an organization",
		icon: CheckCircle,
		number: 3,
	},
};

export default function AddToOrganizationWithFiltersDialog({
	selectedOption,
	setSelectedOption,
	setFilters,
	closeDialog,
	...
	const handlePreviewApprove = () => {
		...
		setCurrentStep(STEPS.SELECT_ORGANIZATION);
	...
	return (
		<div>
			<DialogHeader>
				...
				<DialogDescription>
					Add filtered contacts to Organization
				</DialogDescription>
			</DialogHeader>
			...
			{currentStep === STEPS.FILTERS && (
				<AdvancedFilters
					key="mass-add-toorganization-filters"
					showTrigger={false}
					mode="mass-action"
					onClose={closeDialog}
			...
			{showMainContent && currentStep === STEPS.SELECT_ORGANIZATION && (
