...
const stepConfig = {
	...
	[STEPS.PREVIEW]: {
		...
		description: "Review contacts before deleting",
		icon: Eye,
		number: 2,
	},
};

export default function DeleteWithFiltersDialog({
	filters,
	setFilters,
	closeDialog,
	onSubmit,
	...
	const handleConfirmDelete = async () => {
		...
		try {
			...
			console.error("Error in handleConfirmDelete:", e);
		} finally {
			closeDialog(false);
		}
	};
	...
	return (
		<div>
			<DialogHeader>
				...
				<DialogDescription>
					This will delete <b>all {totalCount} contacts</b> matching your
					filters.
				</DialogDescription>
			</DialogHeader>
